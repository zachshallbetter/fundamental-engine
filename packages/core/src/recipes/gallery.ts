...
export const RECIPE_TIERS: readonly { key: string; label: string; recipes: readonly FieldRecipe[] }[] = [
  { key: 'core', label: 'Core interface & accessibility', recipes: TIER_CORE },
  { key: 'product', label: 'Product, workflow & collaboration', recipes: TIER_PRODUCT },
  { key: 'systems', label: 'Professional systems & governance', recipes: TIER_SYSTEMS },
  { key: 'enterprise', label: 'Enterprise, adaptive & operational', recipes: TIER_ENTERPRISE },
];
