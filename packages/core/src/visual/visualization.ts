...
export const RENDER_MODES: readonly RenderModeInfo[] = [
  ...
  { mode: 'force-vectors', type: 'debug', shows: 'actual cause from apply()', status: 'planned' },
  { mode: 'contours', type: 'scalar', shows: 'equal-value isolines', status: 'planned' },
  { mode: 'potential', type: 'scalar', shows: 'wells and gradients', status: 'planned' },
  { mode: 'energy', type: 'scalar', shows: 'kinetic / potential / thermal', status: 'planned' },
