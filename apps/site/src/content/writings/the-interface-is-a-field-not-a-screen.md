...
- **It is early.** The packages ship — 0.8.1 is published on npm. But this is a young paradigm with no
  user study behind it yet. The claims here are architectural, not the verdict of research. Treat them
  as a thesis being built in the open.
