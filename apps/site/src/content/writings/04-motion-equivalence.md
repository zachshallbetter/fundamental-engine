...
citation keys in [`references.md`](/writings/references) are resolved and
verified before submission — never fabricated.

## Citation coverage

External references this paper relies on, resolved into [`references.md`](/writings/references) where a real
