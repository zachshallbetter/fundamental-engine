...
keys below correspond to verified entries in [`references.md`](/writings/references); no citation is invented solely to satisfy the paper.
...
The Evidence Field is pattern #5 in the 64-recipe gallery and ships as a validated `FieldRecipe`
...
External citation keys/topics referenced above and resolved into [`references.md`](/writings/references) under the trust/evidence group:
