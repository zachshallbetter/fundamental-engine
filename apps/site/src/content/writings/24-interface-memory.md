...
The first Fundamental paper family approaches this problem through a relational field runtime. The flagship paper names the general model; the supporting papers test that model against reading, evidence, motion/accessibility, host portability, recipes, data binding, and diagnostics. This paper pulls one reusable claim out of that family: interfaces should remember meaningful attention, not only clicks: dwell, revisitation, reading trails, review context, and task history can become a legible memory surface that helps users return to where meaning accumulated.
