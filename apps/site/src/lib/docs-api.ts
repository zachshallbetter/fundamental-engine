...
export const HANDLE: MethodRow[] = [
  ...
  { sig: 'readParticleColors(out)', desc: 'Copy each live particle tint into a Uint8Array as packed [r,g,b] (0-255), parallel to readParticles — the carried pigment color a swarm renderer blends with heat; white when uncolored. Hex parsed once per color (memoized), zero-alloc. Shipped-but-unfrozen.' },
