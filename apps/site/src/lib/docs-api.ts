...
export const OPTIONS: OptionRow[] = [
  ...
  { name: 'render', type: "'dots' | 'trails' | 'links' | 'metaballs' | 'streamlines'", def: "'dots'", desc: 'Render mode — the same physics drawn differently.' },
...
export const HANDLE: MethodRow[] = [
  ...
  { sig: 'setRender(mode)', desc: 'Switch the render mode: dots / trails / links / metaballs / streamlines.' },
