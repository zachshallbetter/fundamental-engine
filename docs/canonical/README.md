...
| [`coupling-discipline.md`](coupling-discipline.md) | How to connect a system to the field **at scale**: the three rungs, sampling cadences, when *not* to make something a body, and the reproducibility envelope. |
