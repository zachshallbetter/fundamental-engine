...
> 2026-06-26. See the [series index](README.md) and *the caveat canon* therein. This is a preprint
...
to the core's `compileRecipe`. It turns a `FieldPattern` record into a running field program on a
