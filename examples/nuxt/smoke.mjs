// Headless smoke test: serve the static .output/public/ export and assert a live field booted.
// Proves the published @fundamental-engine/vanilla package works in a Nuxt 3 static generate.
// nuxt.config.ts sets ssr: false and package.json uses `nuxt generate`, so the output is
// plain HTML/CSS/JS in .output/public/.
...
// pages/index.vue assigns createField() result to globalThis.field inside onMounted().
