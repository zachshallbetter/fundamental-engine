...
export const EXPERIMENTAL = [
  ...
  { item: 'performance budget (inspectBudget / DEFAULT_BUDGET)', status: 'partial', note: 'inspectBudget(), withinBudget(), BudgetFinding, and DEFAULT_BUDGET ship in @field-ui/core. QualityGovernor covers adaptive tier detection; the FieldPerf frame-duration split is designed but not yet implemented.' },
